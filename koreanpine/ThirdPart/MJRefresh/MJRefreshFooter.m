...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 初始化文字
        [self setTitle:NSLocalizedString(@"点击加载更多", nil) forState:MJRefreshFooterStateIdle];
        [self setTitle:NSLocalizedString(@"正在加载更多的内容...", nil) forState:MJRefreshFooterStateRefreshing];
        [self setTitle:NSLocalizedString(@"已经全部加载完毕", nil) forState:MJRefreshFooterStateNoMoreData];
    }
    return self;
}
