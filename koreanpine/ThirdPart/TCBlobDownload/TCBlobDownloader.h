...
typedef NS_ENUM(NSUInteger, TCBlobDownloadDocumentType) {
    
    TCBlobDownloadDocumentTypeVideo = 0,
   
    TCBlobDownloadDocumentTypePDF
...
/**
 ...
 @since 1.0
 */
@interface TCBlobDownloader : NSOperation <NSURLConnectionDelegate,NSCoding>
...
@property (nonatomic,assign) TCBlobDownloadDocumentType documentType;
/**
